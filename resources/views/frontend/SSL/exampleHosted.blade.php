            ...
            <div class="col-lg-7">
                <div class="row mb-50">
                    ...
                    {{-- form for cupon --}}
                            ...
                            <input type="text" class="cuponcodeapply" placeholder="Enter Coupon Code...">
                            <p class="cupponError text-danger"></p>
                            <button class="btn btn-md cuponapplybtn" name="login">Apply Coupon</button>
                      
                    </div>
                </div>
                <div class="row">
                    <h4 class="mb-30">Billing Details</h4>
                    {{-- form for billing detals --}}
                        ...
                        <div class="row shipping_calculator">
                            <div class="form-group col-lg-6">
                                <div class="custom_select">
                                    <select class="form-control select-active" id="country" name="country">
                            ...
                            <div class="form-group col-lg-6">
                                <input required="" type="text"  id="state" name="city" placeholder="City / Town *">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <input required="" type="text" id="zip" name="zipcode" placeholder="Postcode / ZIP *">
                            </div>
                            <div class="form-group col-lg-6">
                    ...
                    <div class="table-responsive order_table checkout">
                        <table class="table no-border">
                            <tbody>
                                ...
                                <tr>
                                    <td class="image product-thumbnail"><img src="{{asset('backend/img/Products/'.$product->attributes->thumbnails)}}" alt="product"></td>
                                    <td>
                                ...
                                @endforeach
                                <tr>
                                    <td class="text-heading" colspan="3"><h6 class="text-heading">Discount</h6></td>
                    
                                    <td>
                                        <h4 class="text-brand discountamount">৳</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-heading" colspan="3"><h6 class="text-heading">Total</h6></td>
                    
                                    <td>
                                        <h4 class="text-brand ">৳{{Cart::getTotal();}}</h4>
                                    </td>
                                </tr>
