                    ...
                    <table class="table table-wishlist">
                        ...
                        <form action="{{Route('cart.update',$product->id)}}" method="post">
                            ...
                            <tr class="pt-30">
                                ...
                                <td class="image product-thumbnail pt-40"><img src="{{ asset("backend/img/Products")}}/{{$product->attributes->thumbnails}}" alt="#"></td>
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    <div class="detail-extralink mr-15">
                                        <div class="detail-qty border radius">
                                            <input type="number" name="quantity" class="qty-val" value="{{$product->quantity}}" min="1">      
                                        </div>
                                    </div>
                                </td>
                                <td class="price" data-title="Price">
                                ...
                                <td class="action text-center" data-title="update"><button style="background-color:#FFFFFF; border:none; padding:0; margin:0;" type="submit" class="text-body"><i class="fi-rs-edit"></i></button></td>
